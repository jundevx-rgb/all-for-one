import React4, { useRef, useCallback, useEffect, useState } from 'react';
        ...
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              description && /* @__PURE__ */ jsx("p", { id: descId, className: "text-sm text-gray-500 dark:text-gray-400 mb-4", children: description }),
              children
            ]
          }
        )
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxs(
            "a",
            {
              ...
              children: [
                brand.logo && /* @__PURE__ */ jsx("img", { src: brand.logo, alt: "", className: "h-8 w-auto" }),
                brand.name
              ]
            }
          ),
        ...
        /* @__PURE__ */ jsx(AnimatePresence, { children: mobileOpen && /* @__PURE__ */ jsx(
          motion.div,
          {
            ...
            animate: "visible",
            exit: "exit",
            children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-3 space-y-1 bg-white dark:bg-gray-900", children: [
              links.map((link) => /* @__PURE__ */ jsx(
                "a",
                {
                  href: link.href,
    ...
    "section",
    {
      ...
      children: [
        image && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          overlay && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-black/50 dark:bg-black/70" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full", children: /* @__PURE__ */ jsxs("div", { className: `flex flex-col gap-6 ${alignClasses}`, children: [
          subtitle && /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold uppercase tracking-widest text-blue-400", children: subtitle }),
          /* @__PURE__ */ jsx(
            "h1",
            {
          ...
          cta && (cta.primary || cta.secondary) && /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-4 mt-2", children: [
            cta.primary && /* @__PURE__ */ jsx(
              "a",
              {
...
function Pricing({ plans }) {
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-20 md:py-32 bg-gray-50 dark:bg-gray-950", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: plans.map((plan) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            plan.highlighted && /* @__PURE__ */ jsx("span", { className: "absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 text-xs font-semibold uppercase tracking-wider rounded-full bg-white text-blue-600 shadow", children: "Popular" }),
            /* @__PURE__ */ jsx(
              "h3",
              {
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-6 mb-8", children: [
              /* @__PURE__ */ jsx(
                "span",
                {
            ...
            /* @__PURE__ */ jsx("ul", { className: "space-y-3 mb-8 flex-1", children: plan.features.map((feature, idx) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3 text-sm", children: [
              /* @__PURE__ */ jsx(
                "svg",
                {
...
function Stars({ rating }) {
  return /* @__PURE__ */ jsx("div", { className: "flex gap-0.5", "aria-label": `${rating} out of 5 stars`, children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsx(
    "svg",
    {
...
function Testimonials({
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-20 md:py-32", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: `grid ${layoutClass}`, children: testimonials.map((t, idx) => /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        t.rating && /* @__PURE__ */ jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsx(Stars, { rating: t.rating }) }),
        /* @__PURE__ */ jsxs("blockquote", { className: "text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-6 relative z-10", children: [
          "\u201C",
          t.quote,
          "\u201D"
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mt-auto", children: [
          ...
          ) : /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-600 dark:text-blue-300 font-semibold text-sm", children: t.author.charAt(0).toUpperCase() }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-gray-900 dark:text-white", children: t.author }),
            (t.role || t.company) && /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-500 dark:text-gray-400", children: [
              t.role,
...
function FeatureGrid({
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-20 md:py-32", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: `grid ${colClass} gap-8`, children: features.map((feature, idx) => /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: variant === "numbered" ? /* @__PURE__ */ jsx("span", { className: "text-lg font-bold", children: idx + 1 }) : feature.icon
          }
        ),
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-2", children: feature.title }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400 leading-relaxed", children: feature.description })
      ]
    },
    idx
  )) }) }) });
...
function Newsletter({
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-20 md:py-32", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs(
    "div",
    {
      className: `max-w-2xl mx-auto ${variant === "stacked" ? "text-center" : ""}`,
      children: [
        title && /* @__PURE__ */ jsx("h2", { className: "text-3xl font-extrabold text-gray-900 dark:text-white", children: title }),
        description && /* @__PURE__ */ jsx("p", { className: "mt-3 text-lg text-gray-500 dark:text-gray-400", children: description }),
        ...
        ) : /* @__PURE__ */ jsx("div", { className: "mt-8 p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-300 text-sm font-medium text-center", children: "\u2713 Thanks for subscribing! Check your inbox for a confirmation email." }),
...
function FormField({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1.5", children: [
    ...
    helperText && !error && /* @__PURE__ */ jsx("p", { id: `${id}-helper`, className: "text-xs text-gray-500 dark:text-gray-400", children: helperText }),
    error && /* @__PURE__ */ jsx("p", { id: `${id}-error`, className: "text-xs text-red-600 dark:text-red-400", role: "alert", children: error })
  ] });
}
...
var FormInput = React4.forwardRef(
  function FormInput2({ className, error: hasError, disabled, ...rest }, ref) {
    ...
    return /* @__PURE__ */ jsx("input", { ref, className: classes, disabled, ...rest });
  }
);
var FormTextarea = React4.forwardRef(function FormTextarea2({ className, error: hasError, disabled, ...rest }, ref) {
  const classes = [
    inputBase,
  ...
  return /* @__PURE__ */ jsx("textarea", { ref, className: classes, disabled, ...rest });
});
var FormSelect = React4.forwardRef(
  function FormSelect2({ className, error: hasError, disabled, options, children, ...rest }, ref) {
    ...
    return /* @__PURE__ */ jsx("select", { ref, className: classes, disabled, ...rest, children: options ? options.map(
      (opt, i) => typeof opt === "string" ? /* @__PURE__ */ jsx("option", { value: opt, children: opt }, i) : /* @__PURE__ */ jsx("option", { value: opt.value, children: opt.label }, i)
    ) : children });
  }
);
var FormCheckbox = React4.forwardRef(function FormCheckbox2({ className, label, error: hasError, disabled, id, ...rest }, ref) {
...
export { Button, Card, FeatureGrid, FormCheckbox, FormError, FormField, FormInput, FormLabel, FormSelect, FormTextarea, Hero, Modal, Navbar, Newsletter, Pricing, Testimonials };
